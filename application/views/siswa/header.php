...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('siswa/beranda') ?>">
            ...
            <li class="nav-item">
                ...
                <div id="pembelajaran" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('siswa/mapel'); ?>">Mata Pelajaran</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if (!empty($siswa['foto_siswa'])) : ?>
                                    <img class="img-profile rounded-circle" src="<?= base_url("assets/img/siswa/" . $siswa["foto_siswa"]); ?>">
                                <?php else : ?>
                                    <img class="img-profile rounded-circle" src="<?= base_url("assets/img/siswa/avatar.jpg"); ?>">
                                <?php endif; ?>
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('siswa/beranda'); ?>">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary btn-sm" href="<?= base_url('siswa/logout'); ?>">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>